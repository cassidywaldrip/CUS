...
1.  **Apply for an account:** request an account on the server to the instructors [e.moroegido\@northeastern.edu](mailto:e.moroegido@northeastern.edu) or [h.gibbs\@northestern.edu](mailto:h.gibbs@northeastern.edu).
