...
In this lab, we will walk through how to setup [Google Timeline](google.com/maps/timeline) (previously known as Google Location History) to enable you mobile phone to collect your mobility data. Once we collect enough data, we will analyze it in future sesssions.
...
![Google Maps App with user logged in](../images/googlemaps.jpeg){width="40%"}
...
![Timeline in Google Maps](../images/googletimeline.jpeg){width="40%"}
