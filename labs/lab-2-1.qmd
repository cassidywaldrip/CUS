...
-   Conduct a *social area analysis* using dimensionality reduction (PCA) to identify the factos which differentiate census variables.
...
**Geographic coordinate systems** like [WGS84](https://epsg.io/4326) (EPSG:4325), commonly used in latitude/longitude data represent locations on the Earth's surface using angular measurements. While suitable for global mapping, they aren't ideal for precise distance or area calculations because the Earth is curved.
...
Existing research in the United States has settled on three social *factors* measured by the census which explain social differentiation between areas:
